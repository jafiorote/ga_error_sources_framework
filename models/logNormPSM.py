...
class LogNormPSM():
    ...
    """
    Implements a log-normal based statistical distribution model of mutual information in a system 
    ...
    def get_prob_bins(self):
        ...
        for n in np.arange(n_max):
            ...
            integral = self.lognorm_prob(data[0], data[-1], sigma2[n], expec[n])    ##
